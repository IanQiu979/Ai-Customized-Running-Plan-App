...
// until its own "PRESS TO CONTINUE" is tapped).
...
describe('IntakeScreen guardian consent (captain\'s 2026-09-19 ruling)', () => {
  ...
  it('does not render a consent checkbox for an adult age', async () => {
    ...
    // The loaded intake fixture is already age 34 (an adult); assert the checkbox is absent
    // without needing to touch the field.
  ...
  it('renders and requires the checkbox for age 15, blocking save until checked', async () => {
    ...
    const saveButton = findByAccessibilityLabel(tree, 'Save intake');
    await act(async () => {
